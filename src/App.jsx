          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm sticky top-24">
                ...
                <p className="text-xs text-gray-400 mt-0.5">{selectedStack.length} Technology Selected</p>
                ...
                {selectedStack.length === 0 ? (
                  ...
                  <div className="mt-4 space-y-2.5 max-h-80 overflow-y-auto pr-1">
                    {selectedStack.map((item) => (
                      <div key={item.id} className="flex items-center justify-between p-2.5 border border-gray-100 rounded-xl bg-white shadow-xs">
                        ...
                        <button className="text-gray-300 hover:text-gray-500 text-xs px-1">✕</button>
                      </div>
                    ))}
                  </div>
                )}
...
export default function App() {
  ...
  const handleAddToStack = (tech) => {
    ...
    if (isAlreadyAdded) {
      toast.error(`${tech.name} is already in your stack!`, { position: "top-right" });
    } else {
  ...
  const handleRemoveItem = (id) => {
    ...
    if (removedItem) {
      toast.info(`Removed ${removedItem.name} from stack.`, { position: "top-right" });
    }
  };

  const handleRemoveAll = () => {
    setSelectedStack([]);
    toast.warn("Cleared all technologies from your stack!", { position: "top-right" });
  };
              ...
              <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm sticky top-24">
                ...
                {selectedStack.length > 0 && (
                  <button
                    ...
                    className="mt-6 w-full py-2 border border-rose-200 text-rose-500 rounded-lg text-xs font-semibold hover:bg-rose-50 transition-colors"
                  >
                    Remove All
                  </button>
                )}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#fafafa] font-sans text-slate-800">
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-gray-100 mt-16 text-xs text-gray-500">
        <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-md bg-gradient-to-tr from-pink-500 to-purple-600 text-white flex items-center justify-center font-bold text-[10px]">
                DS
              </div>
            ...
            <p className="mt-3 text-gray-400 text-xs max-w-xs leading-relaxed">
          ...
          <div>
            <h4 className="font-bold text-slate-900 text-xs uppercase tracking-wider mb-3">Legal</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-100 py-6">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-400 text-[11px]">
